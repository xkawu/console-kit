...
class ConsoleKit {
  ...
  comment(message, timestamp = false) {
    const icon = "#";
    const timeText = (0, dayjs_1.default)(new Date(Date.now())).format(
      "HH:mm:ss DD/MM/YYYY"
    );
    console.log(
      `${chalk_1.default.hex(colors.grey)(icon)}  ${chalk_1.default
        .hex(colors.grey)
  ...
  info(message, timestamp = false) {
    ...
    console.log(
      `${chalk_1.default.hex(colors.blue)(icon)}  ${message}${
        timestamp ? ` ❚ ${timeText}` : ""
      }`
    );
  }
  warn(message, timestamp = false) {
    ...
    console.log(
      `${chalk_1.default.hex(colors.yellow)(icon)}  ${message}${
        timestamp ? ` ❚ ${timeText}` : ""
      }`
    );
  }
  success(message, timestamp = false) {
    ...
    console.log(
      `${chalk_1.default.hex(colors.green)(icon)}  ${message}${
        timestamp ? ` ❚ ${timeText}` : ""
      }`
    );
  }
  error(message, timestamp = false) {
    ...
    console.log(
      `${chalk_1.default.hex(colors.red)(icon)}  ${message}${
        timestamp ? ` ❚ ${timeText}` : ""
      }`
    );
  }
  startLoading(message, timestamp = false) {
    ...
    const loader = setInterval(() => {
      process.stdout.write(
        `${chalk_1.default.hex(colors.blue)(`\r${P[x++]}`)}  ${message}${
          timestamp ? ` ❚ ${timeText}` : ""
        }`
      );
      x %= P.length;
  ...
  editProgress(percentage, message) {
    ...
    let empty = " ".repeat(numOfDots - this._currentProgress.percentage / 5);
    process.stdout.write(
      `\r[${chalk_1.default.hex(colors.blue)(
        `${dots}${empty}`
      )}] ${chalk_1.default.bold(`${this._currentProgress.percentage}%`)} ~ ${
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const answer = yield new Promise((resolveOuter) => {
        rl.question(
          `${chalk_1.default.hex(colors.blue)(
            character ? character : "?"
          )}  ${message} ${chalk_1.default.hex(colors.grey)(">")} `,
          function (answer) {
            resolveOuter(answer);
            rl.close();
          }
  ...
  yesno(message, defaultValue) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const answer = yield new Promise((resolveOuter) => {
        rl.question(
          `${chalk_1.default.hex(colors.grey)("[")}${
            defaultValue ? chalk_1.default.hex(colors.green)("Y") : "Y"
          }${chalk_1.default.hex(colors.grey)("/")}${
            defaultValue ? "N" : chalk_1.default.hex(colors.red)("N")
          }${chalk_1.default.hex(colors.grey)(
            "]"
          )}  ${message} ${chalk_1.default.hex(colors.grey)(">")} `,
          function (answer) {
...
Object.defineProperty(exports, "italic", {
  enumerable: true,
  get: function () {
    return chalk_2.italic;
  },
});
Object.defineProperty(exports, "underline", {
  enumerable: true,
  get: function () {
    return chalk_2.underline;
  },
});
